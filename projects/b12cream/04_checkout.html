...
<script language="VB" runat="server">
	...
	Protected Function ChargeCreditCard() As String
		...
		'If TheCreditCardType = "PayPal" Then
			'conn.Close
			'conn = nothing
			'Response.Redirect("/checkoutpaypal.aspx")
		'End If
    ...
    Protected Sub ShippingOptions_Changed(ByVal sender As Object, ByVal e As System.EventArgs)
		...
		'Response.Redirect("checkoutfinal.aspx")
	End Sub
    ...
    Protected Sub OrderNowButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
			...
			Select Case TempCCC
				Case "1"
					'Response.Redirect("/thankyouorder.aspx")
					If TheCreditCardType = "PayPal" Then
						Session("OrderID") = 0
						Response.Redirect("/04_checkoutpaypal.aspx")
					Else
						Response.Redirect("/04_thankyou.aspx")
					End If
				Case "2"		           
    ...
    Sub Page_Load()
        ...
        If Session("ClientID") < 1 Then
            Response.Redirect("http://www.b12cream.com/cart.aspx")
        End If
...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
   	...
   	<title>Place Order | Bioevolve B12 Plus+ Cream</title>

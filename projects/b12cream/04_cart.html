...
<script language="VB" runat="server">
			...
			If Session("InCAD") = 1 Then
				If Session("SynergieTotal") >= 300 Then
					If Session("SynergieTotal") >= 450 Then
						ThePriceC1 = -45
						TheDesc = "Free gifts: Bioevolve B12 Plus+ Cream 15g x 2, Bioevolve Damask Rose Squalene Serum 2mL, Bioevolve Breast Booster 3mL gift trial, Bievolve Easy Slim Treatment 4.5mL gift trial, Purefresh Hair & Body Care Gift Set 60mL Travel Pack"
					Else
						ThePriceC1 = -25
						TheDesc = "Free gifts: Bioevolve B12 Plus+ Cream 15g, Bioevolve Damask Rose Squalene Serum 2mL, Purefresh Hair & Body Care Gift Set 60mL Travel Pack"
					End If
				Else
					ThePriceC1 = -10
					TheDesc = "Free gifts: Bioevolve B12 Plus+ Cream 15g, Bioevolve Damask Rose Squalene Serum 2mL"
				End If
	...
	Sub DoAutoCoupon()
		...
		If NOT SynergieCouponUsed Then
			...
			If Session("SynergieTotal") >= 150 Then
				CouponAmount = -10
				TheDescC = "Free gifts: Bioevolve B12 Plus+ Cream 15g, Bioevolve Damask Rose Squalene Serum 2mL"
			End If

			If Session("SynergieTotal") >= 300 Then
				CouponAmount = -25
				TheDescC = "Free gifts:Bioevolve B12 Plus+ Cream 15g, Bioevolve Damask Rose Squalene Serum 2mL, Purefresh Hair & Body Care Gift Set 60mL Travel Pack"
			End If

			If Session("SynergieTotal") >= 450 Then
				CouponAmount = -45
				TheDescC = "Free gifts: Bioevolve B12 Plus+ Cream 15g x 2, Bioevolve Damask Rose Squalene Serum 2mL, Bioevolve Breast Booster 3mL gift trial, Bievolve Easy Slim Treatment 4.5mL gift trial, Purefresh Hair & Body Care Gift Set 60mL Travel Pack"
			End If
	...
	Sub UpdateQuantity(ByVal sender As Object, ByVal e As EventArgs)
		...
		sql.ExecuteNonQuery
		Conn.Close
		Response.Redirect("04_cart.aspx?A=1")
	End Sub
...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
   	...
   	<title>Shopping Cart | Bioevolve B12 Plus+ Cream</title>
		...
		<div class="grid shopping-cart" id="pageCart">
				    ...
				    <ItemTemplate>
						...
						<div class="col-2of12 cart-body quantity">
							<div runat="server" class='<%# IIf(Eval("Price") < 0.01,"HideQty","") %>'>
								...
								<a href="04_cart.aspx?D=1&I=<%# DataBinder.Eval(Container.DataItem, "ID") %>">	
			...
			<div class="col-12of14 check-out" id="TheCart" runat="server">
				...
				<div class="col-10of12 right">
					<a class="buy right" id="checkout" href="https://www.b12cream.com/04_checkout_new.aspx">CheckOut</a>
				</div>
			</div>
